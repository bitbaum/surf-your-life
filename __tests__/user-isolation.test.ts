...
beforeEach(() => {
  ...
  h.store[MEDICATION_LOG] = [
    { id: MED_A, userId: USER_A, medicationName: "Magnesium", endDate: null, createdAt: new Date() },
    { id: MED_B, userId: USER_B, medicationName: "Sertraline", endDate: null, createdAt: new Date() },
  ]
})
