    ...
    <section className="bg-surface-overlay py-24 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="max-w-2xl mb-16">
          <p className="text-brand-on-overlay text-sm font-semibold tracking-widest uppercase mb-4">{t("gap.label")}</p>
          <h2 className="text-4xl sm:text-5xl font-bold text-ink-on-overlay leading-tight">
            {t("gap.title")}
          </h2>
          <p className="mt-6 text-ink-on-overlay-dim text-lg leading-relaxed">
            {t("gap.body")}
          </p>
        </div>
