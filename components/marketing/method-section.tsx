    ...
    <>
      <section id="method" className="py-24 px-6 bg-surface">
        <div className="max-w-5xl mx-auto">
          <div className="max-w-2xl mb-16">
            <p className="text-brand text-sm font-semibold tracking-widest uppercase mb-4">{t("method.label")}</p>
      ...
      <section className="py-20 px-6 bg-brand">
        <div className="max-w-3xl mx-auto text-center">
          <div className="text-brand-soft text-8xl font-serif leading-none mb-4 select-none">&ldquo;</div>
      ...
      <section id="process" className="py-24 px-6 bg-surface-subtle">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-brand text-sm font-semibold tracking-widest uppercase mb-4">{t("process.label")}</p>
            ...
            {steps.map(({ title, body }, i) => {
              ...
              return (
                <div key={n} className="bg-surface rounded-xl border border-border p-8 shadow-sm">
                  <div className="text-5xl font-bold text-brand-subtle mb-4 leading-none select-none"
                    style={{ textShadow: "0 0 0 var(--color-brand)", WebkitTextStroke: "1.5px var(--color-brand)" }}
                  >
                    {n}
                  </div>
