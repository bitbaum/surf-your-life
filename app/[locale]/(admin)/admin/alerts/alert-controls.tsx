...
export function AlertControls({ search, onSearch, searched, activeTypes, typeFilter, onTypeFilter, visibleCount, resolvingAll, onResolveAll }: Props) {
  ...
  return (
    <>
      <input
        ...
        className="w-full max-w-xs rounded-lg border border-slate-200 px-3 py-1.5 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500"
      />
