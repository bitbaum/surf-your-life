  ...
  return (
    <>
      {assessmentChartData.length >= 2 && (
        <ChartCard
          title={t("detail.assessmentChart.title")}
          subtitle={t("detail.assessmentChart.subtitle")}
        >
