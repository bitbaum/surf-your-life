...
export default async function AtRiskClientsPage({
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <PageHeader title={t("atRisk.title")} description={t("atRisk.description")} />

      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>
              {t("atRisk.title")} ({atRisk.length})
            </CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100">
                    ...
                    <th className="text-left py-2 font-medium text-slate-500">
                      {t("atRisk.lastCheckIn")}
                    </th>
                    <th className="text-left py-2 font-medium text-slate-500">
                      {t("atRisk.inactiveFor")}
                    </th>
                    <th className="text-left py-2 font-medium text-slate-500">
                      {t("atRisk.totalCheckIns")}
                    </th>
                    <th className="text-left py-2 font-medium text-slate-500">
                      {t("atRisk.lastEnergy")}
                    </th>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 text-slate-400">
                          {formatDaysSince(client.lastCheckIn)}
                        </td>
                        <td className="py-3 text-slate-500">
