...
import {
  ...
  API_ERR_EMAIL_ALREADY_VERIFIED,
} from "@/lib/constants";
...
export async function POST() {
  ...
  const { ok: rateOk, retryAfterSecs } = checkRateLimit(
  ...
  sendEmailFire(
    { to: email, subject: EMAIL_SUBJECT_VERIFY, html: verificationEmail({ email, verifyUrl }) },
    "resend-verification",
  );
